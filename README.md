...
## Contribuintes além de [mim](https://github.com/ViniciusAlvesRocha):
- [Gabriel Essêno](https://github.com/GabrielEssenio)
- [Walter Freitas](https://github.com/walterlbf)
...
15 - Mostre quais produtos tem o frete grátis | :heavy_multiplication_x:
...
14 - Limite a quantidade de produtos adicionados ao carrinho pela quantidade disponível em estoque | :heavy_multiplication_x:
7 - Redirecione para uma tela com a exibição detalhada ao clicar na exibição resumida de um produto | :heavy_check_mark:
13 - Mostre junto ao ícone do carrinho a quantidade de produtos dentro dele, em todas as telas em que ele aparece | :heavy_multiplication_x:
9 - Adicione um produto ao carrinho a partir de sua tela de exibição detalhada | :heavy_multiplication_x:
12 - Finalize a compra vendo um resumo dela, preenchendo os seus dados e escolhendo a forma de pagamento | :heavy_multiplication_x:
